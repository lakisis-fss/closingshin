    ...
    collections_to_setup = [
        ...
        },
        {
            ...
            "fields": [
                ...
                {"name": "inst_net_5d", "type": "number"},
                {"name": "foreign_net_5d", "type": "number"},
                {"name": "indiv_net_5d", "type": "number"},
                {"name": "inst_net_15d", "type": "number"},
                {"name": "foreign_net_15d", "type": "number"},
                {"name": "indiv_net_15d", "type": "number"},
                {"name": "inst_net_30d", "type": "number"},
                {"name": "foreign_net_30d", "type": "number"},
                {"name": "indiv_net_30d", "type": "number"},
                {"name": "inst_net_50d", "type": "number"},
                {"name": "foreign_net_50d", "type": "number"},
                {"name": "indiv_net_50d", "type": "number"},
                {"name": "inst_net_100d", "type": "number"},
                {"name": "foreign_net_100d", "type": "number"},
                {"name": "indiv_net_100d", "type": "number"},
        ...
        try:
            ...
            for _, row in df.iterrows():
                payload = {
                    ...
                    "inst_net_5d": float(row.get('기관_5일', 0) or 0),
                    "foreign_net_5d": float(row.get('외인_5일', 0) or 0),
                    "indiv_net_5d": float(row.get('개인_5일', 0) or 0),
                    "inst_net_15d": float(row.get('기관_15일', 0) or 0),
                    "foreign_net_15d": float(row.get('외인_15일', 0) or 0),
                    "indiv_net_15d": float(row.get('개인_15일', 0) or 0),
                    "inst_net_30d": float(row.get('기관_30일', 0) or 0),
                    "foreign_net_30d": float(row.get('외인_30일', 0) or 0),
                    "indiv_net_30d": float(row.get('개인_30일', 0) or 0),
                    "inst_net_50d": float(row.get('기관_50일', 0) or 0),
                    "foreign_net_50d": float(row.get('외인_50일', 0) or 0),
                    "indiv_net_50d": float(row.get('개인_50일', 0) or 0),
                    "inst_net_100d": float(row.get('기관_100일', 0) or 0),
                    "foreign_net_100d": float(row.get('외인_100일', 0) or 0),
                    "indiv_net_100d": float(row.get('개인_100일', 0) or 0),
